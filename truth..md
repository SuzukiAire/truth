...
部屋に置かれているタブレットのようなものから、立体映像でタイトルが表示される。
『ほんとうのわたし』
:::
...
:::
部屋の電気が消える。
しばらくして、部屋にあるタブレットのようなものがオレンジ色に光り、立体映像でゲームのコントローラのようなものが表示される。
プレイヤーがトリガすると、立体映像が消え、電気がつく。
部屋には本が増えている。映画のパッケージやレコードのようなものも増えている。
女王の姿はなく、エレベータが開いている。
